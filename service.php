...
<html>
  <head>
    <title>Silver Coin Bank System</title>
...
<header id="Home">
 <nav class="navbar navbar-expand-lg navbar-light bg-white px-5 border-bottom fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand fs-2" href="#">Silver Coin-<span class="text-primary">Bank System</span></a><br>
...
<br><br><br><br><br>
<section class="services py-5 bg-info" id="Services">
  <div  class="container">
    <div class="text-center my-2">
      <h1 data-aos="fade-up"data-aos-offset="200"> Our<span class="text-dark"> Services
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">see here table of contents.</p>
        <a href="CUSTOMER.php" class="btn btn-primary">View !</a>
      </div>
    </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">see here for transfer money.</p>
        <a href="tranfer.php" class="btn btn-primary">View !</a>
      </div>
    </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4 col-12"> 
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">see here about past activities.</p>
...
<div class="container-fluid bg-primary text-white p-3 text-center fs-4">Developed and Founded.Radhika Wattamwar<br> Silver Coin Foundation</div>
<script 
